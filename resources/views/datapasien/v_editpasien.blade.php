            ...
            <div class="table-responsive">
                <div class="container">
                    ...
                    <div class="basic-form">
                        <form enctype="multipart/form-data"  method="POST" action="/datapasienrm/editpasien" role="form">
                        @csrf <!-- {{ csrf_field() }} -->
                            ...
                            <!-- <div class="form-group ">
                             ...
                             <input type="text" name="jenis_kelamin" class="form-control" placeholder="" value="{{ $pasien[0]->jenis_kelamin }}" required autofocuse>
                            </div> -->
                            <div class="form-group ">
                                <label>Jenis Kelamin</label>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" value="{{ $pasien[0]->tanggal_lahir }}" id="tanggal_lahir" onchange="cari();" readonly> <span class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar-check"></i></span></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="silsilah" class="form-control" placeholder="Silsilah" value="{{ $pasien[0]->silsilah }}" required autofocuse readonly>
                                <!-- <select id="silsilah" name="silsilah" class="form-control" readonly>
                                    <option selected="selected">Choose...</option>
