                            ...
                            @foreach($family as $a)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 300px"><span>
                                            <button type="button" class="btn btn-secondary text-white" onclick="location.href='/datarekammedis/viewdatapasien/{{$a->no_index}}'" data-toggle="tooltip" data-placement="top" title="Buka">
