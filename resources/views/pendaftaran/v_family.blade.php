                ...
                <div class="card-body">
                            ...
                            @foreach($family as $a)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 300px"><span>
                                            <button type="button" class="btn btn-secondary text-white" onclick="location.href='/datapasien/{{ Request::segment(3) }}/{{$a->no_index}}'" data-toggle="tooltip" data-placement="top" title="Buka">
                                                <i class="fa fa-user"></i>
                                            </button>
                                        </span>
                                        <span>
                                            <button type="button" class="btn btn-secondary text-white" onclick="location.href='/datapasien/vieweditfamily/{{ Request::segment(3) }}/{{$a->no_index}}'" data-toggle="tooltip" data-placement="top" title="Edit">
                    ...
                    <div class="card-footer">
                        <div class="rounded-button">
                            <button type="button" onclick="location.href='/daftarantrian/addfamily/{{ Request::segment(3) }}'" class="btn mb-1 btn-rounded btn-primary float-right">Tambah Data</button>
                        </div>
                    </div>
                </div>
            </div>
