                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            @foreach($pasien as $a)
                                ...
                                <tr>
                                    ...
                                    <span>
                                            <button type="button" class="btn btn-secondary text-white" onclick="location.href='/datarekammedisadmin/viewdatapasien/rm/{{$a->no_rm}}'" data-toggle="tooltip" data-placement="top" title="Buka">
