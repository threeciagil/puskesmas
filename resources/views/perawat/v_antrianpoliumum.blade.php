...
<div class="container-fluid">
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 700px">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                            @php
                            ...
                            @foreach($antrian as $a)
                                ...
                                <tr>    
                                            ...
                                            <td class="text-center" style="width: 700px"><span>
                                            <?php if( $a->poli_asal == 'Laboratorium'){ 
                                                ?>
                                            <button style="width: 40px" type="button" onclick="location.href='/poliumum/layanidokter/{{$a->id_antrian}}'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Masuk Antrian Dokter">
                                            Dokter
                                            </button>
                                            <?php } ?>
                                            <?php if( $a->poli_asal != 'Laboratorium'){ 
                                                ?>
                                            <button style="width: 40px" type="button" onclick="location.href='/poliumum/layani/{{$a->id_antrian}}/{{$a->no_rm}}'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Layani">
                                            Layani
                                            </button>
                                            <?php } ?>
                                            <!-- <button style="width: 40px" type="button" onclick="location.href='/poliumum/layani///{//{//$a->id_antrian}}//{//{//$a->no_rm}}'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Layani">
                                            ...
                                            <button style="width: 45px" type="button" onclick="panggil({{$a->id_antrian}},'{{$a->no_antrian}}');" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Panggil" id="panggil">
                                            Panggil
                                            </button>
                                            ...
                                            <a type="button" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus obat ini?')" href="/poliumum/hapus/{{$a->id_antrian}}" data-toggle="tooltip" data-placement="top" title="Hapus">
                                               Hapus
                                                </a>
                                            <!-- <button style="width: 40px" type="button" class="btn btn-danger" onclick="location.href='/poliumum/hapus/{{$a->id_antrian}}'" data-toggle="tooltip" data-placement="top" title="Hapus">
                                                Hapus
                                            </button> -->
                                            <button style="width: 40px" type="button" class="btn btn-warning"  onclick="lewati({{$a->id_antrian}},{{$a->urutan}});"  data-toggle="tooltip" data-placement="top" title="Lewati">
                                            Lewati
                                            </button>
    ...
    function panggil(a , b) {
        var timer = setInterval(function() {
            ...
            // console.log(voices);
            if (voices.length !== 0) {
                var msg = new SpeechSynthesisUtterance('Nomor Antrian '+ b +', Silakan masuk ke antrian poli umum');
                msg.rate = 0.8;
                msg.voice = voices[12];
