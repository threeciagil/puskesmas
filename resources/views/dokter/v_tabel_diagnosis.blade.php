                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            @foreach($data as $datas)
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <a type="button" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus obat ini?')" href="/dataicdx/hapus/{{$datas->id}}" data-toggle="tooltip" data-placement="top" title="Hapus">
          ...
          @csrf     
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="icdx" name="icdx" placeholder="Kode ICD-X" required autofocuse>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label" for="diagnosa">Nama Diagnosa</label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="diagnosa" name="diagnosa" placeholder="Nama Diagnosa" required autofocuse>
                        </div>
                    </div>
                </div>
