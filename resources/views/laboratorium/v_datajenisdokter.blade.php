                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Jenis Pemeriksaan Dokter</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"> {{$jenis->jenis_dokter}}</td>
                                    <td class="text-center"><span>
                                        ...
                                        <span>
                                             <a class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus obat ini?')" href="/laborat/deletedatajenisdokter/{{$jenis->id_jenis_dokter}}" data-toggle="tooltip" data-placement="top" title="Hapus" >
                                               Hapus
                                            </a>
                                        <!-- <button type="button" class="btn btn-danger" onclick="location.href='/laborat/deletedatajenisdokter/{{$jenis->id_jenis_dokter}}'" data-toggle="tooltip" data-placement="top" title="Hapus">
                                                Hapus
                                        </button> -->
                                        </span>
                                    </td>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="/savejenisdokter">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="jenis" placeholder="Jenis Pemeriksaan" required autofocuse>
                        </div>
                    </div>
                </div>
