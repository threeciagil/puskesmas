                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            @foreach($family as $a)
                                ...
                                <tr>
                                    ...
                                    <td>{{$a->no_index}}</td>
                                    <td><span>
                                            <button type="button" class="btn btn-secondary text-white" onclick="location.href='/datarekammedislab/laboratrmdatapasien/{{$a->no_index}}'" data-toggle="tooltip" data-placement="top" title="Buka">
