                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <a class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus obat ini?')" href="/laborat/deletedatapemeriksaandokter/{{$datas->id_data_laborat_dokter}}/{{$datas->id}}" data-toggle="tooltip" data-placement="top" title="Hapus" >
                                               Hapus
                                            </a>
                                            <!-- <button type="button" class="btn btn-danger" onclick="location.href='/laborat/deletedatapemeriksaandokter/{{$datas->id_data_laborat_dokter}}/{{$datas->id}}'" data-toggle="tooltip" data-placement="top" title="Hapus">
...
<div class="modal" id="basicModal1" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="/savepemeriksaandokter">
                @csrf
                
                <input type="hidden" value="{{$datadokter[0]->id_jenis_dokter}}" name="id_jenis" class="form-control" >
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input readonly type="text" class="form-control" name="nama_jenis_lab" value="{{$datadokter[0]->jenis_dokter}} " placeholder="Jenis Pemeriksaan Lab" required autofocuse>
                            <input type="hidden" class="form-control" name="jenis_lab" value="{{$datadokter[0]->id_jenis_dokter}} " placeholder="Jenis Pemeriksaan Lab" required autofocuse>
                            <input type="hidden" class="form-control" name="id_dokter" value="{{$datadokter[0]->id_data_laborat_dokter}} " placeholder="Jenis Pemeriksaan Lab" required autofocuse>
                    </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">Nama Pemeriksaan</label>
                        <div class="col-lg-6">
                             <input readonly type="text" name="nama_pemeriksaan_dokter" value="{{$datadokter[0]->nama}} " class="form-control" placeholder="Nama Pemeriksaan" required autofocuse>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input readonly type="text" name="tarif" value="{{$datadokter[0]->tarif}} " class="form-control" placeholder="Tarif" required autofocuse>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
